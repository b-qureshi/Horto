...
import com.example.horto.common.opengl.IndexBuffer;
...
import com.example.horto.common.opengl.Texture;
...
public class PlaneRenderer {
  ...
  // MODIFICATION made by Bilal Qureshi - 10/04/2021 - Remove ground texture attached to the plane, replaced with shader properties
  // Shader names.
   ...
   * a {@link Render.Renderer} callback, typically in {@link
   * Render.Renderer#onSurfaceCreated}.
   */
  public PlaneRenderer(Render render) throws IOException {
    shader =
  ...
  public void drawPlanes(
          Render render, Collection<Plane> allPlanes, Pose cameraPose, float[] cameraProjection) {
