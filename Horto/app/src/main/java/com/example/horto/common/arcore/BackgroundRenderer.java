...
public class BackgroundRenderer {
   ...
   */
  public void setUseDepthVisualization(Render render, boolean useDepthVisualization)
      throws IOException {
   ...
   */
  public void setUseOcclusion(Render render, boolean useOcclusion) throws IOException {
  ...
  public void drawVirtualScene(
          Render render, Framebuffer virtualSceneFramebuffer, float zNear, float zFar) {
